...
const connectMessage = "Hi Derek, I found your card and I'd like to connect."
...
function connectSmsHref() {
  ...
  return `sms:+19417999357${isIOS ? "&" : "?"}body=${body}`
}

const actions = [
  { label: "Email", href: "mailto:info@peacockpremierpainting.com", Icon: Mail },
  { label: "Call", href: "tel:+19417999357", Icon: Phone },
  { label: "Text", href: "sms:+19417999357", Icon: MessageSquare },
  {
    label: "Connect",
    // Static iOS-style fallback for no-JS; onClick rebuilds it per-platform with the live URL.
    href: `sms:+19417999357&body=${encodeURIComponent(connectMessage)}`,
    Icon: Share,
    primary: true,
